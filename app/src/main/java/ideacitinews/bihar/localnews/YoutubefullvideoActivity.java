...
public class YoutubefullvideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_youtubefullvideo);
        ...
        adapter = new FullVideoShowAdapter(YoutubefullvideoActivity.this,youtubevideoModelArrayList);
